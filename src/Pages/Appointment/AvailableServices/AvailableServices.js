...
const AvailableServices = ({ date }) => {
    ...
    const {data:services,isLoading,refetch} = useQuery(['available',formattedDate], () => fetch(`https://doctors-portal-server-side-bice.vercel.app/available?date=${formattedDate}`)
        .then(res => res.json()))
