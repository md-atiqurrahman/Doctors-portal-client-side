...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://doctors-portal-server-side-bice.vercel.app/service').then(res => res.json()))
    ...
    const onSubmit = async (data) => {
        ...
        .then(result => {
            if(result.success === true){
                ...
                fetch('https://doctors-portal-server-side-bice.vercel.app/doctors', {
                    method: 'POST',
                    headers: {
